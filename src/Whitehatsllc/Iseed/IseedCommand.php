...
class IseedCommand extends Command
{
            ...
            if (!file_exists($fileName) || $this->option('force')) {
                $this->printResult(
                        app('iseed')->generateSeed(
                                $table, $this->option('database'), $chunkSize, $prerunEvent, $postrunEvent
                        ), $table
                );
                continue;
            }
    ...
    protected function getOptions()
    {
        return array(
            ...
            array('database', null, InputOption::VALUE_OPTIONAL, 'database connect settings config/database.php'),
